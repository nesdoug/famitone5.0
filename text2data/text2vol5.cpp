// text2vol5.cpp  version 5.1: Defines the entry point for the console application.
...
int output_header(char *songname, int song)
{
	...
	fprintf(outfile, ";this file for FamiTone5.1 library generated by text2vol5 tool\n");
...
int main(int argc, char *argv[])
{
	...
	if (argc<2)
	{
		...
		printf("Usage: text2data.exe song.txt [-ca65 or -asm6][-ch1..5][-s][-allin][-Wno]\n");
